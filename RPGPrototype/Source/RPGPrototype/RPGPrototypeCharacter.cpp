...
void ARPGPrototypeCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Shift", IE_Pressed, this, &ARPGPrototypeCharacter::Shift);
	PlayerInputComponent->BindAction("Shift", IE_Released, this, &ARPGPrototypeCharacter::StopShift);
...
void ARPGPrototypeCharacter::Shift()
{
	bShift = true;
}

void ARPGPrototypeCharacter::StopShift()
{
	bShift = false;
}


void ARPGPrototypeCharacter::Turn(float Rate)
{
	if (bShift)
	{
